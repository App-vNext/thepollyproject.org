...
Today we [released Polly v5.0 in alpha to Nuget](https://web.archive.org/web/20250224010544/https://www.nuget.org/packages/polly). This is the next step in making Polly a much wider resilience framework for .NET, as Hystrix is for Java.

TL;DR, the new resilience policies and features are:

- [Bulkhead isolation](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Bulkhead) - 'Don't let one fault sink the whole ship!'
- [Timeout policy](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Timeout) - what it says on the tin... but with support for timing-out *any* delegate
- [Fallback policy](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Fallback) - 'If all else fails, degrade gracefully'
- [PolicyWrap](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/PolicyWrap) - Combine strategies, for 'defence in depth'
- [New context keys](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Keys-And-Context-Data) to enrich logging and support metrics
...
- [family](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly#retry) of [Retry](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Retry) strategies
- [Circuit-Breaker](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Circuit-Breaker)
- [Advanced Circuit-Breaker](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Advanced-Circuit-Breaker)
...
[Bulkhead isolation](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Bulkhead) proactively isolates the execution of your delegates to limited resource (thread) pools, so that one stream of actions going rogue can't sink the whole ship.
...
The [deep doco on the wiki](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Bulkhead#configuration-recommendations) discusses this (and other configuration options) more deeply.

### Timeout policy

[Timeout policy](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Timeout), erm, does what it says on the tin ... but with a twist.
...
Pessimistic timeout lets your calling thread *still* walk away from these ungovernable calls - if they haven't returned within the timeout - at the cost (in sync variants only) of an extra thread. Polly also lets you [capture the timed-out task later with a task continuation](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Timeout#pessimistic-timeout-1), to mop up any badness that may have occurred.
...
... when all else fails. Similar syntax provides alternative actions to be run on fallback, for [void-returning calls](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Fallback#void-returning-calls).
...
There are in fact no restrictions on how you combine policies, but the [deeper wiki documentation provides guidance](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/PolicyWrap#ordering-the-available-policy-types-in-a-wrap).
...
As we [add metrics and dashboarding to Polly](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Polly-Roadmap), these keys will form the bedrock for identifying what's happening where in your app, in real-time.

For more, see [Keys and Context Data](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Keys-And-Context-Data) on the wiki.
...
The full v5.0 release notes are [here](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/blob/v5.0-alpha/CHANGELOG.md).
...
To feed back on v5.0, join us on [github](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/), [slack](https://web.archive.org/web/20250224010544/http://www.pollytalk.org/), or comment on this post.

## Where next?

**CachePolicy** is already in development, intending to target in-memory cache, disk cache, HttpCache, and a range of cloud cache providers from Redis thru Azure blob and aws s3. Tell us [in the github issue](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/issues/136) or [on slack](https://web.archive.org/web/20250224010544/http://www.pollytalk.org/) if there are other cache providers you'd like supported!

The [longer-term roadmap](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki/Polly-Roadmap) envisages:
...
Comment on the roadmap [here](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/issues/90).

## Finding out more

This blog post can inevitably only give a taste of what the new resilience policies offer. For full details, see the deep doco for each policy on the [wiki](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/wiki), and the [readme](https://web.archive.org/web/20250224010544/https://github.com/App-vNext/Polly/tree/v5.0-alpha#resilience-policies).
