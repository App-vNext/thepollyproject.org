...
The above scenario is now handled more directly with a [dedicated variant of the `sleepDurationProvider` delegate on wait-and-retry policies](https://github.com/App-vNext/Polly/wiki/Retry#when-the-response-specifies-how-long-to-wait-before-retrying).
...
Finally, a brief look backward: `Context` was extended in v5.0.6 to aid tracking of policy executions in logging and metrics. [Four keys were added](https://github.com/App-vNext/Polly/wiki/Keys-and-Context-Data) and are available as part of every execution:
...
The [wiki documentation](https://github.com/App-vNext/Polly/wiki/Keys-and-Context-Data) describes in detail how each key can be set.
